package com.example.alex.tpdm_u3_practica1_alexisvargas;
...
public class MainActivityPlatillos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_platillos);
        ...
        adapter=new ArrayAdapter<>(MainActivityPlatillos.this,android.R.layout.simple_list_item_1,platillos);
        ...
        cancelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MainActivityPlatillos.this.finish();
            }
        });
    ...
    private void borrarElemento(int indice) {
        if(indice==-1){
            ...
            for (int i=0;i<temp.size();i++){
                if(indice!=i){
                    myRef.push().setValue(new Platillo(temp.get(i).split(" - ")[0],Integer.parseInt(temp.get(i).split(" - ")[1])));
                }
